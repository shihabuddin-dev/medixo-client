...
export function LoginForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  return (
    <div className="py-10 relative min-h-screen flex items-center justify-center px-4 text-gray-300 overflow-hidden">
      ...
      {/* Background */}
      <div className="spline-container absolute top-0 left-0 w-full h-full -z-10"><iframe src="https://my.spline.design/spaceparticlesanimation-UGnU6SB7nUK6sFI6N5WzasEx" frameBorder="0" width="100%" height="100%" id="aura-spline"></iframe></div>
