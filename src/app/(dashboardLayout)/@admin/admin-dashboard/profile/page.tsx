    ...
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground dark:text-gray-400 font-medium">
          Manage your administrative credentials and security layer
          configuration.
        </p>
      </div>
            ...
            <div className="mt-8 space-y-4 pt-6 border-t dark:border-white/10">
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground dark:text-gray-500 flex items-center gap-2 font-black text-[10px] uppercase tracking-widest">
                  <Shield className="h-4 w-4 text-primary" /> System Privilege
                </span>
                <span className="text-indigo-600 dark:text-indigo-400 font-black uppercase text-[10px] bg-indigo-50 dark:bg-indigo-500/10 px-3 py-1 rounded-md tracking-widest border border-indigo-100 dark:border-indigo-500/20">
                  ADMIN_VERIFIED
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground dark:text-gray-500 flex items-center gap-2 font-black text-[10px] uppercase tracking-widest">
                  <Calendar className="h-4 w-4 text-primary" /> Deployment Date
                </span>
